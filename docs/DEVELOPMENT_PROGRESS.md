...
| ID | 功能 / 需求 | 状态 | 说明 |
| --- | --- | --- | --- |
| V2-001 | Person 人物模型 | 🔵 | Issue #128 / Person Foundation V1：owner-scoped explicit people model；名称、结构化别名、关系标签、私有备注、revision-safe CRUD；不包含 Person↔Memory/图谱边、AI 自动创建或链接 |
