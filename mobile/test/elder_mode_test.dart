...
void main() {
  test('Flutter elder theme keeps normal default and enlarges shared targets', () {
    ...
    final normalTitleMediumSize = normal.textTheme.titleMedium?.fontSize ?? 16;
    final normalHeadlineSmallSize = normal.textTheme.headlineSmall?.fontSize ?? 24;
    expect(elder.textTheme.titleMedium?.fontSize, 22);
    expect(elder.textTheme.headlineSmall?.fontSize, 30);
    expect(
      elder.textTheme.titleMedium!.fontSize!,
      greaterThan(normalTitleMediumSize),
    );
    expect(
      elder.textTheme.headlineSmall!.fontSize!,
      greaterThan(normalHeadlineSmallSize),
    );
